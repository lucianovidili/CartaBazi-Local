...
import (
	...
	//"os"									//Descomentar para usar en el server de Google Cloud.

	"github.com/gorilla/mux"
	"github.com/tealeg/xlsx"
	//"google.golang.org/appengine"			//Descomentar para usar en el server de Google Cloud.
	//"github.com/gorilla/handlers"			//Descomentar para usar en el server de Google Cloud.
)
...
func main() {
	...
	//Creación y seteo del servidor. Comentar para NO usar en el server de Google Cloud.
	server := &http.Server{
		Addr: ":8080",
		//Addr:           ":3000",
		Handler:        r,
	...
	//Uso de la App Engine para escuchar en el server de Google Cloud.
	//http.Handle("/", handlers.CombinedLoggingHandler(os.Stderr, r))
	//appengine.Main()

	//Setear al servidor en estado de Escucha y Servicio. Cuando se esté en testing local, comentar las dos lineas de arriba de la App Engine y descomentar esta de abajo.
